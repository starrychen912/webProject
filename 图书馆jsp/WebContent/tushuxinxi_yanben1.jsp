...
<!-- 									名称：<input name="mingcheng" type="text" id="mingcheng" class="form-control2" /> -->
...
<!-- 									<input name="chubandi" type="text" id="chubandi" class="form-control2" /> -->
									...
									<input type="submit" onclick="submitForm(2)" value="关键字查询" class="btn btn-info btn-small" style="background-color:#F2F6FC ;border-color: #E4E7ED;color: #3c3f3c;"/> 
								</form>				
						...
						<td style="padding-left:0px; padding-right:0px;"><table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bordercolor="#F3F3F3" bgcolor="white" class="table table-striped table-bordered table-hover">
                          <tr>
                            <td width="30px" height="50" align="center" bgcolor="white">序号</td>
    ...
    <td>${u.zhuangtai}</td>
                              ...
                              <td height="50" align="center"> <a class="btn btn-info btn-small" href='jieyuejilu_add.jsp?id=${u.id}' style="background-color:#3c3f3c ;border-color: #E4E7ED;">添加借阅记录</a> <a class="btn btn-info btn-small" href="tushuxinxiDetail.do?id=${u.id}" style="background-color:#F2F6FC ;border-color: #E4E7ED;color: #3c3f3c;">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
