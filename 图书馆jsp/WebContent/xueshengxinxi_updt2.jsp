...
<link rel="stylesheet" href="images/hsgcommon/common.css" type="text/css">
	...
	<body>
			<form action="updateXueshengxinxi2.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="white">
							<td height="20" colspan="2" background="images/table_header.gif">修改读者信息<input type="hidden" name="id" value="${xueshengxinxi.id}" /></td>
						</tr>
		...
		<tr 0><td width="200" align="center">照片：</td><td><input name='zhaopian' type='text' id='zhaopian' size='50' value='' onblur=''  class="form-control" /><div style="margin-top:16px;">&nbsp;<input type='button' value='上传' onClick="up('zhaopian')" style="background-color:#7e817e ;border-color: #E4E7ED;"/></div></td></tr>
		<tr 1><td width="200" align="center">余额：</td><td><input name='yue' type='text' id='yue' value='' onblur='' class="form-control" readonly="readonly" /></td></tr>
	...
	<script language="javascript">document.form1.yue.value='${xueshengxinxi.yue}';</script>
