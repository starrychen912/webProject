...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateTushuleibie.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="white">
							<td height="30" colspan="2" background="images/table_header.gif">修改图书类别<input type="hidden" name="id" value="${tushuleibie.id}" /></td>
						</tr>
						<tr ><td width="200">类别：</td><td><input name='leibie' type='text' id='leibie' value='' onblur='hsgcheck()' class="form-control" />&nbsp;*<label id='clabelleibie' style='margin-top:16px;' /></td></tr>
						...
						<script language="javascript">document.form1.leibie.value='${tushuleibie.leibie}';</script>
