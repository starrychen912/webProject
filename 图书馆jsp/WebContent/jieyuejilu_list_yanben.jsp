			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						...
						<td style="padding-left:0px; padding-right:0px;"><table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bordercolor="#F3F3F3" bgcolor="#ebf0f7" class="table table-striped table-bordered table-hover">
                          <tr>
                            ...
                            <td align='center' bgcolor='#ebf0f7'>图书编号</td>    <td align='center' bgcolor='#ebf0f7'>名称</td>    <td align='center' bgcolor='#ebf0f7'>类别</td>    <td align='center' bgcolor='#ebf0f7'>状态</td>    <td align='center' bgcolor='#ebf0f7'>借阅人</td>    <td  width='65' align='center' bgcolor='#ebf0f7'>借阅时间</td>    <td  width='65' align='center' bgcolor='#ebf0f7'>归还时间</td>    <td align='center' bgcolor='#ebf0f7'>费用</td>    <td align='center' bgcolor='#ebf0f7'>是否归还</td>    
				...
				%>
                            <tr align="center">
                             ...
                             <td>${u.tushubianhao}</td>    <td>${u.mingcheng}</td>    <td>${u.leibie}</td>    <td>${u.zhuangtai}</td>    <td>${u.jieyueren}</td>    <td>${u.jieyueshijian}</td>    <td>${u.guihuanshijian}</td>    <td>${u.feiyong}</td>    <td>${u.shifouguihuan}</td>    
                              <td height="50" align="center"> ${u.addtime } </td>
                              <td height="50" align="center"> <!--lianjie1--> <a class="btn btn-info btn-small" href="jieyuejiluDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
