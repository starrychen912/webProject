...
%>
  <body >
    ...
    <table width="80%" height="126" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#c7c6c6" style="border-collapse:collapse">
    <tr>
    ...
    <tr>
      ...
      <input name="Submit" type="submit"  onClick="return check()" value="确定" class="btn btn-info btn-small" style="background-color:#3c3f3c ;"/>
      <input name="Submit2" type="reset" value="重置" class="btn btn-info btn-small" style="background-color:#F2F6FC ;border-color: #E4E7ED;color: #3c3f3c;"/></td>
      </tr>
  </table>
  </form>
  </body>
