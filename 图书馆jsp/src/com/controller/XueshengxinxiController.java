...
//	分页查询
	...
	public String xueshengxinxiList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Xueshengxinxi xueshengxinxi, String xuehao, String mima, String xingming, String xingbie, String shenfenzheng, String dianhua, String yuanxi, String banji, String jiguan, String zhaopian, String yue, String beizhu){
